...
from cpfssr.data.data_util import four_paths_from_meta_info_file
...
class StereoSRImageDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            # print("img_gt:",img_gt)
            # print("img_lq:",img_lq)
            # print("img_gt[0]:",img_gt[0])
            # print("img_gt[1]:",img_gt[1])
            # print("img_lq[0]:",img_lq[0])
            # print("img_lq[1]:",img_lq[1])
            # print(len(img_gt))
            # print(len(img_lq))
            # print(len(img_gt[0]))
            # print(len(img_lq[1]))
            ...
            img_gt_l, img_gt_r, img_lq_l, img_lq_r = augment([img_gt[0], img_gt[1], img_lq[0], img_lq[1]],
                                                             ...
                                                             self.opt['use_vflip'])
            # print("img_lq[1]:",img_lq_l)
            # print("img_lq[1]:",img_lq_r)
