...
from cpfssr.archs.cpfssr_arch import CPFSSR, CPFSSR_Local


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--input', type=str, default='./datasets/StereoSR_test/Flickr1024/lr_x2/', help='input test image folder') # datasets/Flickr1024/lr_x4
    parser.add_argument('--output', type=str, default='results/CPFSSR/Flickr1024', help='output folder') # results/CPFSSR/Set5
    parser.add_argument('--task', type=str, default='CPFSSR_Local', help='CPFSSR, CPFSSR_Local')
    ...
    parser.add_argument('--model_path', type=str,
                        default='experiments/pretrained_models/CPFSSR/CPFSSR_SSRx2.pth')
    ...
    for idx, path in enumerate(sorted(glob.glob(os.path.join(args.input, '*')))):
        ...
        with torch.no_grad():
            ...
            window_size = 16
            # _, _, h, w = img.size()
            _, _, h, w = (torch.cat([img_l, img_r], 1)).size()
